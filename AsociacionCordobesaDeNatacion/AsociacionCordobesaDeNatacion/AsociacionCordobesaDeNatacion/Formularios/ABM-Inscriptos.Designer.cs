namespace AsociacionCordobesaDeNatacion.Formularios
{
    partial class ABM_Inscriptos
    {
        ...
        private void InitializeComponent()
        {
			...
			this.dataGridEspecialidad.DataSource = this.especialidadBindingSource1;
			...
			this.dataGridNadador.DataSource = this.nadadoresBindingSource1;
			...
			this.dataGridTorneo.DataSource = this.torneosBindingSource1;
