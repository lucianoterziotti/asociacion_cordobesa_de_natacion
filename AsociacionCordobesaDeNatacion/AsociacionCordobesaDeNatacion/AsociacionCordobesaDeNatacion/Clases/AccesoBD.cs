...
namespace AsociacionCordobesaDeNatacion.Clases
{
	class AccesoBD
	{
		...
		string cadena_conexion = "Provider=SQLNCLI11;Data Source=DESKTOP-5RVUN41\\BELENSQL;Persist Security Info=True;User ID=sa;Initial Catalog=PAV;password=Belen123";
